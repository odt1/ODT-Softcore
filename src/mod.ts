    ...
    public postDBLoad(container: DependencyContainer): void {
            ...
            if (config.SecureContainersOptions.Progressive_Containers.enabled) {
                try {
                    ...
                    for (const profile of profileList) {
                        tables.templates.profiles[profile].bear.character.Inventory.items.find((x) => x.slotId == "SecuredContainer")._tpl =
                            "5732ee6a24597719ae0c0281"
                        tables.templates.profiles[profile].usec.character.Inventory.items.find((x) => x.slotId == "SecuredContainer")._tpl =
                            "5732ee6a24597719ae0c0281"
                    }
                    ...
                    const alpha: IHideoutProduction = {
                    ...
                    const gamma : IHideoutProduction = {
                    ...
                    for (const profile of profileList) {
                        try {
                            ...
                            tables.templates.profiles[profile].bear.character.Inventory.items
                                .filter(
                                    (x) => x._tpl == "5811ce572459770cba1a34ea" || x._tpl == "5811ce662459770f6f490f32" || x._tpl == "5811ce772459770e9e5f9532"
                                )
                                .forEach((element) => {
                    ...
                    for (const stage in tables.hideout.areas[area].stages) {
                        tables.hideout.areas[area].stages[stage].constructionTime = Math.round(
                            tables.hideout.areas[area].stages[stage].constructionTime /
                                config.HideoutOptions.Faster_Hideout_Construction.Hideout_Construction_Time_Multiplier
                        )
                    }
                }
            }
        ...
        if (config.AdditionalCraftingRecipes.enabled == true) {
            try {
                ...
                const Trimadol : IHideoutProduction = {
                ...
                const Meldonin : IHideoutProduction = {
                ...
                const Perfotran : IHideoutProduction = {
                            ...
                            if (x == "59faff1d86f7746c51718c9c" && config.EconomyOptions.Barter_Economy.Unban_Bitcoins_For_Barters.enabled == true) {
                                ...
                                if (items[x]._props.CanSellOnRagfair == true) {
                                    logger.warning(
                                        `\nItem ${getItemName(
                                            x
                                        )} can be bought on flea for free, don't use BSG blacklist removals with EconomyOptions.Barter_Economy.enabled!`
                                    )
                                }
                            }
                        })
        ...
        if (config.CraftingRebalance.enabled == true) {
            ...
            try {
                ...
                getCraft("60098ad7c2240c0fe85c570a").requirements.find((x) => x.templateId == "5751a25924597722c463c472").templateId =
                ...
                getCraft("62a0a16d0b9d3c46de5b6e97").requirements.find((x) => x.templateId == "590c621186f774138d11ea29").templateId =
                ...
                getCraft("57347ca924597744596b4e71").requirements.find((x) => x.templateId == "5c05300686f7746dce784e5d").templateId =
                ...
                getCraft("5d1b5e94d7ad1a2b865a96b0").requirements.find((x) => x.templateId == "590c37d286f77443be3d7827").templateId =
                ...
                // Hawk nerf
                getCraftID("5dd3c9c8449c0c31795b0f0b").requirements.find((x) => x.templateId == "57347b8b24597737dd42e192").templateId =
                ...
                getCraftID("5ffcac4e1285295b7441ee01").requirements.find((x) => x.templateId == "590a3efd86f77437d351a25b").templateId =
                ...
                getCraft("590a358486f77429692b2790").requirements.find((x) => x.templateId == "5af0561e86f7745f5f3ad6ac").templateId =
                    "59e35de086f7741778269d84"

                // Thermite buff
                getCraft("60391a8b3364dc22b04d0ce5").requirements.find((x) => x.templateId == "5780cf722459777a5108b9a1").templateId =
