...
import { BarterEconomy} from "src/types";
...
import { fleaBarterRequestBlacklist, fleaBarterRequestBlacklistItems } from "src/assets/fleamarket";
...
export class BarterEconomyChanger{
    ...
    public apply(config: BarterEconomy) {
        ...
        this.adjustCashOffers(config.cashOffersPerentage);
    ...
    private doBarterEconomy(){
        this.ragfairConfig.dynamic.barter.itemTypeBlacklist = fleaBarterRequestBlacklist;
    ...
    private adjustCashOffers(cashOffersPerentage: number) {
        this.ragfairConfig.dynamic.barter.chancePercent = 100 - cashOffersPerentage;
    }
