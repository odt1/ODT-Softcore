...
import { OtherTweaks } from "src/types";
...
export class OtherTweaksChanger {
    ...
    doUnexaminedItemsAreBack() {
        ...
        for(const item of Object.values(this.items)){
            if(item._parent === BaseClasses.BUILT_IN_INSERTS || item._parent === BaseClasses.MAGAZINE || item._parent === BaseClasses.CYLINDER_MAGAZINE || item._parent === BaseClasses.ARMOR_PLATE){
                continue;
            }
