...
export const craftingAdjustments = [
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_GAS_MASK_AIR_FILTER,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            craft.count = 2;
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.MEDICAL_CALOKB_HEMOSTATIC_APPLICATOR,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            let requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.MEDKIT_IFAK_INDIVIDUAL_FIRST_AID_KIT,
            );
            if (!requirement) {
                return;
            }
            requirement.count = 1;
            requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.MEDICAL_ARMY_BANDAGE,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_PORTABLE_POWERBANK,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_MEDICAL_TOOLS,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            craft.count = 1;
            let requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.INFO_SECURE_FLASH_DRIVE,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.INFO_MILITARY_FLASH_DRIVE,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_MILITARY_CIRCUIT_BOARD,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            let requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_VPX_FLASH_STORAGE_MODULE,
            );
            if (!requirement) {
                return;
            }
            ...
            requirement.count = 1;
            requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_PRINTED_CIRCUIT_BOARD,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            let requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_CLASSIC_MATCHES,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            craft.count = 3;
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.BARTER_GAS_ANALYZER,
            );
            if (!requirement) {
                return;
            }
    ...
    },
    {
        ...
        adjust: (craft: IHideoutProduction) => {
            const requirement = craft.requirements.find(
                (requirement) => requirement.templateId === ItemTpl.KEY_DORM_ROOM_308,
            );
            if (!requirement) {
                return;
            }
