const fleaBarterRequestWhitelist = [
	// Used for generating blacklists
	// base classes = parent IDs for actual items, not nodes
	...
	// "543be6564bdc2df4348b4568", // Throwable weapon0
